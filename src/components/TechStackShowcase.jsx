...
const TechStackShowcase = () => {
  ...
  // Ref and inView for root section
  const sectionRef = useRef(null);
  const sectionInView = useInView(sectionRef, { once: true, amount: 0.2 });

  // Ref and inView for tech cards group
  ...
  return (
    <motion.section
      className="services-showcas__glass-container"
      ref={sectionRef}
        ...
        >
          {techStack.map((tech) => (
            <motion.div
              ...
              whileHover={{ scale: 1.07, boxShadow: "0px 4px 16px rgba(100,255,200,0.18)" }}
              style={{
            ...
            >
              <div className="tech-card__inner">
                <motion.div
                  className="tech-icon"
                  whileHover={{ rotate: 11, scale: 1.19 }}
                  transition={{ type: "spring", stiffness: 330, damping: 10 }}
                >
                  {tech.icon}
                </motion.div>
